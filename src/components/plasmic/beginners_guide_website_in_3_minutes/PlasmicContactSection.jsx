...
import sty from "./PlasmicContactSection.module.css"; // plasmic-import: TU3Z218kSa9l/css
...
function PlasmicContactSection__RenderFunc(props) {
  ...
  return (
    <Stack__
      ...
      id={"contact"}
    >
      <div className={classNames(projectcss.all, sty.freeBox__jDZaM)}>
        <h2
        ...
        <div className={classNames(projectcss.all, sty.freeBox__vwO4)}>
          <a
